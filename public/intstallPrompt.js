  ...
  return (
    <div className="fixed bottom-20 left-0 right-0 mx-4 mb-4 bg-white rounded-lg shadow-xl p-4 z-50 border-2 border-pink-500">
      <div className="flex items-center justify-between">
        ...
        <button onClick={handleDismiss} className="ml-2 text-gray-400 hover:text-gray-600">
          ✕
        </button>
      </div>
      <div className="flex gap-2 mt-3">
        ...
        <button onClick={handleDismiss} className="px-4 text-gray-600 hover:text-gray-800">
          Later
        </button>
      </div>
    </div>
